# !/usr/bin/env python
# Author: sd582 / http://www.forum-raspberrypi.de/Thread-led-4-segment-i2c-display?pid=137411#pid137411
...
# Alphabet
# HexDigits = [0x77, 0x7c, 0x58, 0x58, 0x5e, 0x71, 0x3D, 0x74, 0x10, 0x0e, 0x70,
#              0x38, 0x37, 0x54, 0x5c, 0x73, 0x67, 0x50, 0x6d, 0x78, 0x3e, 0x62, 0x7e, 0x76, 0x6e, 0x5b]

# SpecialChars
# _, -, ,SPACEBAR
# HexDigits = [0x08, 0x40, 0x64, 0x00]

# top four segments loop
# HexDigits = [0x01, 0x02, 0x40, 0x20]
